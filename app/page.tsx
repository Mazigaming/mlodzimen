          ...
          <div className="grid md:grid-cols-2 gap-20 lg:gap-32 items-center relative z-10">
            ...
            <div className="space-y-10">
              ...
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-black leading-tight tracking-tight hero-reveal">
                <span className="text-gradient-warm">Transformuj</span>
                <span className="block text-white mt-3">Swoją Przyszłość</span>
              </h1>

              <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-lg font-light hero-reveal">
                Edukacja od ludzi Twojego pokolenia, którzy rozumieją co oznacza rzeczywista zmiana.
              </p>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6 border-l-4 border-l-amber-400 pl-8">
                  <p className="text-gray-300 text-lg leading-relaxed">
                    Edukacja nie powinna być nudna. To nie są kolejne kursy na YouTube z bot-głosem. To są realni ludzie, którzy niedawno byli w Twoim miejscu.
                  </p>
                  <p className="text-gray-300 text-lg leading-relaxed">
                    Każdy mentor tutaj uczy nie bo musi, ale bo chce dzielić się tym co wie. Bez biurokracji, bez pazerności. Tylko rzeczywisty transfer wiedzy od pokolenia do pokolenia.
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          <div className="grid md:grid-cols-3 gap-8 lg:gap-10">
            {[
              {
                title: 'Społeczność',
                description: 'Nie jesteś sam. Tysiące mentorów i uczniów budują to razem.',
                icon: '👥',
                accent: 'border-l-4 border-l-blue-400',
              },
              {
                title: 'Po Prostu Działa',
                description: 'Bez zbędnych filmów, bez martwej teorii. Praktyka od razu.',
                icon: '⚡',
                accent: 'border-l-4 border-l-amber-400',
              },
              {
                title: 'Rzeczywisty Wzrost',
                description: 'Nie certyfikat. Rzeczywiste umiejętności, które zmienią Twoją karierę.',
                icon: '🚀',
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-10 lg:gap-14">
            ...
            <div data-scroll-reveal className="interactive-card rounded-2xl p-10 border-l-4 border-l-blue-400 border border-slate-700/50 h-full flex flex-col hover:border-slate-600 hover:bg-white/5 transition-all duration-300">
              ...
              <h3 className="text-3xl font-black text-white mb-5">Jestem Uczniem</h3>
              <p className="text-gray-300 mb-10 text-lg leading-relaxed flex-grow">
                Ucz się rzeczywiście. Od mentorów, którzy nauczają bo chcą, a nie bo muszą.
              </p>
              <ul className="space-y-4 mb-10 text-gray-300">
                <li className="flex items-start gap-3">
                  <span className="text-cyan-400 text-xl flex-shrink-0 mt-0.5">→</span>
                  <span className="text-base font-medium">Mentoring jeden-na-jeden</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-cyan-400 text-xl flex-shrink-0 mt-0.5">→</span>
                  <span className="text-base font-medium">Rzeczywiste projekty</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-cyan-400 text-xl flex-shrink-0 mt-0.5">→</span>
                  <span className="text-base font-medium">Bez długich filmów</span>
                </li>
              </ul>
            ...
            <div data-scroll-reveal className="interactive-card rounded-2xl p-10 border-l-4 border-l-cyan-400 border border-slate-700/50 h-full flex flex-col hover:border-slate-600 hover:bg-white/5 transition-all duration-300">
              ...
              <h3 className="text-3xl font-black text-white mb-5">Jestem Mentorem</h3>
              <p className="text-gray-300 mb-10 text-lg leading-relaxed flex-grow">
                Dziel się wiedzą. Buduj kadrę następnego pokolenia. Zarabiaj fair.
              </p>
              <ul className="space-y-4 mb-10 text-gray-300">
                <li className="flex items-start gap-3">
                  <span className="text-blue-400 text-xl flex-shrink-0 mt-0.5">→</span>
                  <span className="text-base font-medium">Własne kursy i program</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-400 text-xl flex-shrink-0 mt-0.5">→</span>
                  <span className="text-base font-medium">Wsparcie dedykowane</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-400 text-xl flex-shrink-0 mt-0.5">→</span>
                  <span className="text-base font-medium">Zarabiaj zaraz</span>
                </li>
              </ul>
        ...
        <div className="container mx-auto px-4 text-center max-w-4xl relative z-10">
          <div data-scroll-reveal className="space-y-12">
            <div className="inline-block speech-bubble mb-8">
              <span className="text-2xl">Ready to start? 🚀</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 leading-relaxed font-light max-w-2xl mx-auto">
              Nie czekaj. Edukacja od ludzi Twojego pokolenia czeka na Ciebie.
            </p>
